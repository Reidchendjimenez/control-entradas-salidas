...
void main() {
  // En tests (nativo), kIsWeb = false → el proxy se salta.
  test('sitio oficial directo: parsea el bloque #dolar', () async {
    var llamadas = 0;
  ...
  test('respaldo: bcv.today cuando sitio oficial falla', () async {
    var llamadas = 0;
    final client = MockClient((req) async {
      llamadas++;
  ...
  test('lanza StateError si las fuentes fallan', () async {
