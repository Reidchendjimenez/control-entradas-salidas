...
## Corpus Check
- 129 files · ~157,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1679 nodes · 4217 edges · 110 communities (80 shown, 30 thin omitted)
...
Cohesion: 0.16
Nodes (26): get_db_adaptive(), Generator que proporciona una sesión SQLite local., build_detalle_row(), build_empty_state(), build_producto_busqueda_item(), build_requisicion_card(), _parse_dt(), Tarjeta de una requisición en la lista. (+18 more)

### Community 16 - "RequisicionesView"
Cohesion: 0.09
Nodes (7): _colors(), Lee la cola de sync y pinta el indicador: ok / pendientes / fallidos., Fuerza una sincronización con Supabase y recarga la lista., Indicador de estado de la cola de sync (pendientes/fallidos/ok)., Al pulsar: refresca el estado y muestra los errores si hay fallidos., RequisicionesView, VisualizeView
...
### Community 35 - "audit_view.py"
Cohesion: 0.18
Nodes (6): AuditView, crear_ajuste_stock(), get_requisicion_audit_data(), marcar_detalle_verificado(), Crea un movimiento de ajuste para corregir la cantidad inicial., Obtiene los datos necesarios para la vista de auditoría.
...
### Community 56 - "requisiciones/helpers.py"
Cohesion: 0.40
Nodes (3): _get_color(), get_colors_safe(), Obtiene color dinámico desde constantes de ft.Colors.
