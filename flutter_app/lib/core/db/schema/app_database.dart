...
class Existencias extends Table {
  ...
  TextColumn get almacen => text().withLength(max: 50)();
...
/// Cola de sincronización (outbox) — réplica de `sync_queue.py`.
...
/// Metadatos de la sincronización (último sync, versiones marcadas).
...
/// Operador del dispositivo — réplica de `dispositivo_usuario` (login_view.py).
...
class AppDatabase extends _$AppDatabase {
  AppDatabase() : super(driftDatabase(name: 'control_entradas_salidas'));
